              ...
              <div className="footer-menu">
                ...
                <div className="social-links mt-4">
                  ...
                  <ul className="d-flex list-unstyled gap-3">
                    <li>
                      <a href="#" className="btn btn-outline-primary rounded-circle" style={{width: '45px', height: '45px'}} title="Facebook">
                        {/* Facebook SVG */}
                    ...
                    <li>
                      <a href="#" className="btn btn-outline-primary rounded-circle" style={{width: '45px', height: '45px'}} title="Twitter">
                        {/* Twitter SVG */}
                        <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24">
                    ...
                    <li>
                      <a href="#" className="btn btn-outline-primary rounded-circle" style={{width: '45px', height: '45px'}} title="Instagram">
                        {/* Instagram SVG */}
                        <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24">
